    ...
    <div ref={containerRef} className="relative">
      ...
      {abierto && (
        <>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 max-h-[70vh] rounded-t-2xl bg-white shadow-2xl flex flex-col md:absolute md:inset-auto md:right-0 md:bottom-auto md:top-full md:mt-2 md:w-96 md:max-h-[28rem] md:rounded-xl md:border md:border-gray-200">
